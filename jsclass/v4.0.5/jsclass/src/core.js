...
JS.extend(JS.Method.prototype, {
  ...
  compile: function(environment) {
    ...
    var StackTrace = trace && (exports.StackTrace || jellybean('./stack_trace').StackTrace);
...
JS.Method.tracing = function(classes, block, context) {
  var pkg = exports.jellybean ? exports : jellybean('./loader');
  pkg.jellybean('JS.StackTrace', function(StackTrace) {
